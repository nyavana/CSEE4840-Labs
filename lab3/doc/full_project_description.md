...
Copy the output_files/soc_system.rbf into the boot partition of your sd card. You can mount your sd card on your workstation and copy the file. Alternatively, mount the boot partition by running mount /dev/mmcblk0p1 /mnt on your DE1-SoC then use scp to copy the file from your workstation to your board, e.g.,
